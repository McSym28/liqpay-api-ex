defmodule LiqPayAPI.ConfirmationTest do
  ...
  describe "sender_verify/2" do
    test "[200] performs a request, encodes SenderVerify.Request from request's body and encodes SenderVerify.Response from response's body" do
  ...
  describe "mpi/2" do
    test "[200] performs a request, encodes MPI.Request from request's body and encodes MPI.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
...
19RVvxNX7UlwbkPtiLGL0ETFgzsK6rbFur4T+7fsHPamnMg==",
  ...
  describe "three_ds/2" do
    test "[200] performs a request, encodes ThreeDS.Request from request's body and encodes ThreeDS.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
  ...
  describe "receiver_verify/2" do
    test "[200] performs a request, encodes ReceiverVerify.Request from request's body and encodes ReceiverVerify.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
  ...
  describe "otp/2" do
    test "[200] performs a request, encodes OTP.Request from request's body and encodes OTP.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
  ...
  describe "card_verification/2" do
    test "[200] performs a request, encodes CardVerification.Request from request's body and encodes CardVerification.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
  ...
  describe "cvv/2" do
    test "[200] performs a request, encodes CVV.Request from request's body and encodes CVV.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
