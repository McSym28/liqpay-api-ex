    ...
    test "[200] performs a request, encodes ThreeDS.Request from request's body and decodes ThreeDS.Response from response's body" do
      ...
      expect(@httpoison, :request, fn :post,
        ...
        assert {:ok, body_encoded} =
                 Jason.encode(%{
                   ...
                   "create_date" => 1_715_003_097_923,
                   "currency" => "UAH",
                   "currency_credit" => "UAH",
                   "currency_debit" => "UAH",
                   "description" => "Мій товар",
                   "end_date" => 1_715_263_624_913,
                   "ip" => "10.29.92.115",
                   "is_3ds" => true,
                   "language" => "uk",
      ...
      assert {:ok,
              %LiqPayAPI.Confirmation.ThreeDS.Response{
                ...
                commission_credit: 0.0,
                commission_debit: 0.0,
                create_date: ~U[2024-05-06 13:44:57.923Z],
                currency: "UAH",
                currency_credit: "UAH",
                currency_debit: "UAH",
                description: "Мій товар",
                end_date: ~U[2024-05-09 14:07:04.913Z],
                ip: "10.29.92.115",
                is_3ds: true,
                language: "uk",
                liqpay_order_id: "L1BRDTFS1715003138473469",
    ...
    test "[200] performs a request, encodes CardVerification.Request from request's body and decodes CardVerification.Response from response's body" do
      ...
      expect(@httpoison, :request, fn :post,
        ...
        assert {:ok, body_encoded} =
                 Jason.encode(%{
                   ...
                   "create_date" => 1_717_055_610_442,
                   "currency" => "UAH",
                   "currency_credit" => "UAH",
                   "currency_debit" => "UAH",
                   "description" => "test card varification",
                   "end_date" => 1_717_055_614_216,
                   "ip" => "8.8.0.0",
                   "is_3ds" => true,
                   "language" => "uk",
      ...
      assert {:ok,
              %LiqPayAPI.Confirmation.CardVerification.Response{
                ...
                commission_debit: 0.0,
                confirm_phone: "380933454182",
                create_date: ~U[2024-05-30 07:53:30.442Z],
                currency: "UAH",
                currency_credit: "UAH",
                currency_debit: "UAH",
                description: "test card varification",
                end_date: ~U[2024-05-30 07:53:34.216Z],
                ip: "8.8.0.0",
                is_3ds: true,
                language: "uk",
                liqpay_order_id: "X8GKGS111717055610320758",
