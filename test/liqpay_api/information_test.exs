defmodule LiqPayAPI.InformationTest do
  ...
  describe "receive_receipt/2" do
    test "[200] performs a request, encodes ReceiveReceipt.Request from request's body and encodes ReceiveReceipt.Response from response's body" do
  ...
  describe "payment_archive/2" do
    test "[200] performs a request, encodes PaymentArchive.Request from request's body and encodes PaymentArchive.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
  ...
  describe "status_payment/2" do
    test "[200] performs a request, encodes StatusPayment.Request from request's body and encodes StatusPayment.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
  ...
  describe "adding_data/2" do
    test "[200] performs a request, encodes AddingData.Request from request's body and encodes AddingData.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
