defmodule LiqPayAPI.TokensTest do
  ...
  describe "obtain/2" do
    test "[200] performs a request, encodes Obtain.Request from request's body and encodes Obtain.Response from response's body" do
  ...
  describe "change_status/2" do
    test "[200] performs a request, encodes ChangeStatus.Request from request's body and encodes ChangeStatus.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
