defmodule LiqPayAPI.InternetAcquiring.TwoStepTest do
  ...
  describe "complete/2" do
    test "[200] performs a request, encodes Complete.Request from request's body and encodes Complete.Response from response's body" do
  ...
  describe "block/2" do
    test "[200] performs a request, encodes Block.Request from request's body and encodes Block.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
