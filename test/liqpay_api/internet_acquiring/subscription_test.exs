defmodule LiqPayAPI.InternetAcquiring.SubscriptionTest do
  ...
  describe "edit/2" do
    test "[200] performs a request, encodes Edit.Request from request's body and encodes Edit.Response from response's body" do
  ...
  describe "unsubscribe/2" do
    test "[200] performs a request, encodes Unsubscribe.Request from request's body and encodes Unsubscribe.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
