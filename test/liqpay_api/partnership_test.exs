defmodule LiqPayAPI.PartnershipTest do
  ...
  describe "shop_edit/2" do
    test "[200] performs a request, encodes ShopEdit.Request from request's body and encodes ShopEdit.Response from response's body" do
  ...
  describe "info_user/2" do
    test "[200] performs a request, encodes InfoUser.Request from request's body and encodes InfoUser.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
  ...
  describe "info_merchant/2" do
    test "[200] performs a request, encodes InfoMerchant.Request from request's body and encodes InfoMerchant.Response from response's body" do
      expect(@client, :perform, fn operation, pipeline ->
        params = OpenAPIClient.Client.Operation.get_private(operation, :__params__)
