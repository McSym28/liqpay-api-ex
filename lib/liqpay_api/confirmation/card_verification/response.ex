defmodule LiqPayAPI.Confirmation.CardVerification.Response do
  @moduledoc """
  Provides struct and type for a Confirmation.CardVerification.Response
  """
  ...
  @type t :: %__MODULE__{
          acq_id: number | nil,
          action: :cardverification | String.t() | nil,
          ...
          status: :"3ds_verify" | :error | :failure | :success | String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      action: {"action", {:enum, [{:cardverification, "cardverification"}, :not_strict]}},
