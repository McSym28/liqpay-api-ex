defmodule LiqPayAPI.Tokens.ChangeStatus.Response.CardTokenInfo do
  @moduledoc """
  Provides struct and type for a Tokens.ChangeStatus.Response.CardTokenInfo
  """
  ...
  defstruct [:status, :token_exp_date, :token_ref, :token_suffix]
