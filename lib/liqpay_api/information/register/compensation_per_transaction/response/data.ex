defmodule LiqPayAPI.Information.Register.CompensationPerTransaction.Response.Data do
  @moduledoc """
  Provides struct and type for a Information.Register.CompensationPerTransaction.Response.Data
  """
