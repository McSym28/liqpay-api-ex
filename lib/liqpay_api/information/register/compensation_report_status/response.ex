defmodule LiqPayAPI.Information.Register.CompensationReportStatus.Response do
  @moduledoc """
  Provides struct and type for a Information.Register.CompensationReportStatus.Response
  """
