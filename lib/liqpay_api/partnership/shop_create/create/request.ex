defmodule LiqPayAPI.Partnership.ShopCreate.Create.Request do
  @moduledoc """
  Provides struct and type for a Partnership.ShopCreate.Create.Request
  """
  ...
  @type t :: %__MODULE__{
          ...
          aggregator: LiqPayAPI.Partnership.ShopCreate.Create.Request.Aggregator.t() | nil,
  ...
  @enforce_keys [:description, :email, :name, :phone, :site]
  defstruct [
    :aggregator,
  ...
  def __fields__(:t) do
    [
      action: {"action", {:enum, agent_shop_create: "agent_shop_create"}},
      aggregator:
        {"aggregator", {LiqPayAPI.Partnership.ShopCreate.Create.Request.Aggregator, :t}},
