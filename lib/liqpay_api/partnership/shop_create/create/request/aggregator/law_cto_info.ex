defmodule LiqPayAPI.Partnership.ShopCreate.Create.Request.Aggregator.LawCTOInfo do
  @moduledoc """
  Provides struct and type for a Partnership.ShopCreate.Create.Request.Aggregator.LawCTOInfo
  """
