defmodule LiqPayAPI.Partnership.ShopCreate.Register.Request.Aggregator.LawOwnersInfo do
  @moduledoc """
  Provides struct and type for a Partnership.ShopCreate.Register.Request.Aggregator.LawOwnersInfo
  """
