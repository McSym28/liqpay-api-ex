defmodule LiqPayAPI.InternetAcquiring.APay.EncryptedToken.Request.Sender do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.APay.EncryptedToken.Request.Sender
  """
