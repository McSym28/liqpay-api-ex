defmodule LiqPayAPI.InternetAcquiring.APay.DecryptedToken.Request.Sender do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.APay.DecryptedToken.Request.Sender
  """
