defmodule LiqPayAPI.InternetAcquiring.DCC.Response do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.DCC.Response
  """
  ...
  @type t :: %__MODULE__{
          ...
          dcc_allowed: [LiqPayAPI.InternetAcquiring.DCC.Response.DCCAllowed.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      dcc_allowed: {"dcc_allowed", [{LiqPayAPI.InternetAcquiring.DCC.Response.DCCAllowed, :t}]},
