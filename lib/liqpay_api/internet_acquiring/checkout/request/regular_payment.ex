defmodule LiqPayAPI.InternetAcquiring.Checkout.Request.RegularPayment do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.Checkout.Request.RegularPayment
  """
