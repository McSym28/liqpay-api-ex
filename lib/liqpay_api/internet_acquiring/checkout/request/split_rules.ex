defmodule LiqPayAPI.InternetAcquiring.Checkout.Request.SplitRules do
  ...
  @type t :: %__MODULE__{
          ...
          rro_info: LiqPayAPI.InternetAcquiring.Checkout.Request.SplitRulesRroInfo.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      rro_info:
        {"rro_info", {LiqPayAPI.InternetAcquiring.Checkout.Request.SplitRulesRroInfo, :t}},
