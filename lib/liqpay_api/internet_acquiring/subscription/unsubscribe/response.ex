defmodule LiqPayAPI.InternetAcquiring.Subscription.Unsubscribe.Response do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.Subscription.Unsubscribe.Response
  """
