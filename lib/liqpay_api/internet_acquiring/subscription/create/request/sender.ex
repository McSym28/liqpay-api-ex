defmodule LiqPayAPI.InternetAcquiring.Subscription.Create.Request.Sender do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.Subscription.Create.Request.Sender
  """
