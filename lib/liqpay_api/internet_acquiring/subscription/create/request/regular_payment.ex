defmodule LiqPayAPI.InternetAcquiring.Subscription.Create.Request.RegularPayment do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.Subscription.Create.Request.RegularPayment
  """
