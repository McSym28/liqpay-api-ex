defmodule LiqPayAPI.InternetAcquiring.CardPayment.Response do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.CardPayment.Response
  """
  ...
  @type t :: %__MODULE__{
          ...
          dcc_allowed: [LiqPayAPI.InternetAcquiring.CardPayment.Response.DCCAllowed.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      dcc_allowed:
        {"dcc_allowed", [{LiqPayAPI.InternetAcquiring.CardPayment.Response.DCCAllowed, :t}]},
