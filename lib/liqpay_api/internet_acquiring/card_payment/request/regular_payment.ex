defmodule LiqPayAPI.InternetAcquiring.CardPayment.Request.RegularPayment do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.CardPayment.Request.RegularPayment
  """
