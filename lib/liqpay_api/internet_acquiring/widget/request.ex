defmodule LiqPayAPI.InternetAcquiring.Widget.Request do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.Widget.Request
  """
  ...
  @type t :: %__MODULE__{
          ...
          info: String.t() | nil,
          language: :en | :uk | nil,
          one_click_payment: LiqPayAPI.InternetAcquiring.Widget.Request.OneClickPayment.t() | nil,
          order_id: String.t(),
          paytypes:
            :apay
            | :card
          ...
          public_key: String.t(),
          regular_payment: LiqPayAPI.InternetAcquiring.Widget.Request.RegularPayment.t() | nil,
          result_url: String.t() | nil,
          sender: LiqPayAPI.InternetAcquiring.Widget.Request.Sender.t() | nil,
          server_url: String.t() | nil,
          split_rules: [LiqPayAPI.InternetAcquiring.Widget.Request.SplitRules.t()] | nil,
          verifycode: true | nil,
          version: 3
        }
  @type types :: :t
  ...
  def __fields__(:t) do
    [
      ...
      one_click_payment:
        {"one_click_payment", {LiqPayAPI.InternetAcquiring.Widget.Request.OneClickPayment, :t}},
      ...
      regular_payment:
        {"regular_payment", {LiqPayAPI.InternetAcquiring.Widget.Request.RegularPayment, :t}},
      result_url: {"result_url", {:string, :uri}},
      sender: {"sender", {LiqPayAPI.InternetAcquiring.Widget.Request.Sender, :t}},
      server_url: {"server_url", {:string, :uri}},
      split_rules: {"split_rules", [{LiqPayAPI.InternetAcquiring.Widget.Request.SplitRules, :t}]},
