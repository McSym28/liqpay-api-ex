defmodule LiqPayAPI.InternetAcquiring.GPay.EncryptedToken.Request.Sender do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.GPay.EncryptedToken.Request.Sender
  """
