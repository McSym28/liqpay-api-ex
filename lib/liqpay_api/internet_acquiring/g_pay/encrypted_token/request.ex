defmodule LiqPayAPI.InternetAcquiring.GPay.EncryptedToken.Request do
  @moduledoc """
  Provides struct and type for a InternetAcquiring.GPay.EncryptedToken.Request
  """
  ...
  @type t :: %__MODULE__{
          ...
          sender: LiqPayAPI.InternetAcquiring.GPay.EncryptedToken.Request.Sender.t() | nil,
          server_url: String.t() | nil,
          split_rules:
            [LiqPayAPI.InternetAcquiring.GPay.EncryptedToken.Request.SplitRules.t()] | nil,
          tavv: String.t(),
          version: 3
        }
  @type types :: :t
  ...
  def __fields__(:t) do
    [
      ...
      paytype: {"paytype", {:enum, gpay_tavv: "gpay_tavv"}},
      ...
      sender: {"sender", {LiqPayAPI.InternetAcquiring.GPay.EncryptedToken.Request.Sender, :t}},
      server_url: {"server_url", {:string, :uri}},
      split_rules:
        {"split_rules",
         [{LiqPayAPI.InternetAcquiring.GPay.EncryptedToken.Request.SplitRules, :t}]},
