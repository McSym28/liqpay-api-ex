  ...
  default: [
    ...
    naming: [
      rename: [
        ...
        {~r/^(InternetAcquiring\.Invoice\.Units\.Response\.)OneOf0$/, "\\1MultiLanguage"},
        {~r/^(InternetAcquiring\.Invoice\.Units\.Response\.)OneOf1$/, "\\1SingleLanguage"},
